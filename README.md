...
3.Batch Normalization.pdf

4.Resnet_the importance to use residule.pdf

5.Target-dropout, a kind of network pruning technology.pdf

6.wide_deep_deep understanding of DNN.pdf
...
(由于资源都在网上，有部分网站会发生重新整理的情况，所以会出现内容与网站对不上的情况)
